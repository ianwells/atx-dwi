...
We're seeing some similar periodicity within years.  Let's plot both at the same time.
...
both.monthly <- select(both.monthly,date,apd,dwi)
...
forecast <- predict(dwi.pre.count.hw, n.ahead = 11, prediction.interval = T, level = 0.9)
